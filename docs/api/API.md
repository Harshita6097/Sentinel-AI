...
```json
{
  "time": "11:00", "current_minutes": 660, "paused": false,
  "finished": false, "speed": 1, "progress": 0.36,
  "active_events": [...], "location_overrides": {...}
}
```

### `GET /timeline`
All 16 timeline events.
...
```json
{
  "image_hash": "abc123",
  "analysis": {
    "flood_detected": true, "coverage_percent": 54,
    "risk_level": "High", "affected_zones": ["River banks"],
    "water_depth_estimate": "moderate", "model_used": "mock-segformer-v0"
  },
  "scene_description": {
    "caption": "...", "key_observations": [...],
    "infrastructure_status": "...", "civilian_presence": "...",
...
Response: Full `Incident` object with extracted entities, severity, confidence.

### `GET /incidents`
Query parameters: `severity` (Critical/High/Medium/Low), `status` (Open/Acknowledged/Resolved), `limit` (default 100).
...
### `POST /mock`
Load 5 pre-seeded Kerala flood reports.
...
// or
{ "destination": "Kottayam", "resource_id": "Ambulance-01" }
```
...
Used by the main dashboard (polled every 2s).
