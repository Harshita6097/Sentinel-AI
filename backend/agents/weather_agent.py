...
The COP write interface is unchanged.
"""
...
class WeatherAgent:
    ...
    def _sim_forecast(sim_minutes: int) -> WeatherForecast:
        ...
        return WeatherForecast(
            condition=condition, rainfall_mm_hr=rainfall, alert_level=alert,
            wind_kmh=wind, visibility=visibility, confidence=confidence, source="simulation",
        )
