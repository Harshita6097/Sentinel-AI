...
backend (FastAPI)
    ...
    │   └── weather_agent     Escalation table + live API
...
- [x] Production pytest test suite
- [x] Render + Vercel deployment configs
- [x] Architecture + API + interview documentation
...
- [Interview Prep](docs/INTERVIEW_PREP.md) — STAR explanation, trade-offs, likely questions
